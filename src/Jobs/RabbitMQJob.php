...
namespace Pavelmgn\GptPulseConnector\Jobs;
...
class RabbitMQJob extends Job implements JobContract
{
    ...
    public function release($delay = 0)
    {
        ...
        $body['gptpulse_meta_data']['attempts'] = $attempts + 1;
    ...
    public function attempts()
    {
        ...
        return isset($body['gptpulse_meta_data']['attempts']) ? (int) $body['gptpulse_meta_data']['attempts'] : 0;
    }
    ...
    {
        return array_except(json_decode($this->message->body, true), 'gptpulse_meta_data');
    }
